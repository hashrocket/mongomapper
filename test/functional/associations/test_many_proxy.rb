...
class ManyProxyTest < Test::Unit::TestCase
  ...
  context "Finding scoped to association" do
    ...
    context "with :all" do
      should "work" do
        @project1.statuses.find(:all, :sort => [["position", "asc"]]).should == [@brand_new, @complete]
      end
      ...
      should "work with order" do
        statuses = @project1.statuses.find(:all, :sort => [['name', 'asc']])
    ...
    context "with #all" do
      should "work" do
        @project1.statuses.all(:sort => [["position", "asc"]]).should == [@brand_new, @complete]
      end
      ...
      should "work with order" do
        statuses = @project1.statuses.all(:sort => [['name', 'asc']])
        statuses.should == [@complete, @brand_new]
      end
    end
    ...
    context "with :first" do
      should "work" do
        @project1.statuses.find(:first, :sort => [['name', 'asc']]).should == @complete
      end
    ...
    context "with #first" do
      should "work" do
        @project1.statuses.first(:sort => [['name', 'asc']]).should == @complete
      end
    ...
    context "with :last" do
      should "work" do
        @project1.statuses.find(:last, :sort => [["position", "asc"]]).should == @complete
      end
    ...
    context "with #last" do
      should "work" do
        @project1.statuses.last(:sort => [["position", "asc"]]).should == @complete
      end
    ...
    context "with #paginate" do
      setup do
        @statuses = @project2.statuses.paginate(:per_page => 2, :page => 1, :sort => [['name', 'asc']])
      end
